public class SensorDataProcessor {
    ...
    public void calculateData(double d) {
        ...
        int i, j, k = 0;
        double[][][] data2 = new
    double[sensorData.length][sensorData[0].length][sensorData[0][0].length];
